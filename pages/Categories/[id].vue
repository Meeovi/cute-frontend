<template>
    <div>
        ...
        <section class="services4 cid-sobGKbCXrl" id="services4-1n">
            <div class="container">
                <div class="row">
                    <!--Card-1-->
        ...
        <section class="services1 cid-sobGFVIUfm" id="services1-1k">
            <!---->
        ...
        <section class="features18 popup-btn-cards cid-sobGIJUqYR" id="features18-1m">
                    ...
                    <div class="card p-3 col-12 col-md-6 col-lg-4">
                        <div class="card-wrapper">
                            ...
                            <div class="card-box">
                                ...
                                <p class="mbr-text mbr-fonts-style display-7">
                                    All sites you make with Mobirise are mobile-friendly. You don't have to create a
                                    special mobile version of your site.
                                </p>
                            </div>
                        </div>
                    </div>
