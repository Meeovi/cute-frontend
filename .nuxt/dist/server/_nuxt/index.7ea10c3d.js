...
import { _ as _sfc_main$1, a as _sfc_main$2, b as _sfc_main$3, c as _sfc_main$4, d as _sfc_main$5, e as _sfc_main$6 } from "./wishlists.7bc03435.js";
import "../server.mjs";
import "ofetch";
...
const __default__ = {
  components: {
    ...
    loyalty: _sfc_main$3,
    reviews: _sfc_main$4,
    wishlists: _sfc_main$5,
    designers: _sfc_main$6
  },
  data: () => ({
    tab: "option-1"
  })
...
const _sfc_main = /* @__PURE__ */ Object.assign(__default__, {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(_component_v_card, { class: "settingsCard" }, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            _push2(ssrRenderComponent(_component_v_tabs, {
              ...
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<h5${_scopeId2}>Projects</h5>`);
                  ...
                  _push3(`<h5${_scopeId2}>Account</h5>`);
                  ...
                  _push3(ssrRenderComponent(_component_v_tab, { value: "option-7" }, {
                    default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                      if (_push4) {
                        ...
                        _push4(`<a href="/"${_scopeId3}>Logout</a>`);
                      } else {
                        return [
                          createVNode(_component_v_icon, { start: "" }, {
                            default: withCtx(() => [
...
//# sourceMappingURL=index.7ea10c3d.js.map
